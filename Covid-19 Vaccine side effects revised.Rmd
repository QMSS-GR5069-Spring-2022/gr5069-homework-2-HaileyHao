...
############################
# File Name: Covid-19 Vaccine Tweets and Side Effects Report
# Date: March 22, 2022
# Version: R 3.2
# Input Files: "vaccination_all_tweets_ansi.csv"
# Output Files: 
# Purpose: 
############################
...
#whether the data is processed or what is inside the dataset can be described in the comments
```
...
library(stopwords)
#delete stop words to allow more precise analysis for the texts on tweets.
...
```{r echo=FALSE,,dpi= 300,out.width = '70%',out.height = '70%'}
#plot the timeline of sentiments of tweets for Covid vaccines
